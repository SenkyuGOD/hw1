...
<div class="container">
    ...
    <form action="Controller" method="post" class="form-signin">
        ...
        <a href="Controller?command=auth" class="btn btn-lg btn-success">Зарегистрироваться</a>
    </form>
    <p class="text-center">Уже есть аккаунт? <a href="Controller?command=auth">Войти</a></p>
</div>
